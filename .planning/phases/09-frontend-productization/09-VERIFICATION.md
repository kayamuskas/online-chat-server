...
- Re-verification on 2026-04-21 confirmed the browser-level unread and infinite-history flows through the Playwright suite (`unread-sidebar.spec.ts`, `history-load.spec.ts`, `autoscroll.spec.ts`) and confirmed the Account hub sign-out path manually in the shipped UI.
...
---
_Verified: 2026-04-21T09:12:00Z_  
